...
public class MemberMenu {
	//Scanner 객체 생성(전역적으로 다 입력받을수 있도록)
...
//					mc.deleteMember(userId);
	...
	public void inputMember() {
		...
		String hoppy = sc.nextLine();
		
		// 회원 추가 요청 == Controller메소드 요청
		mc.insertMember(userId, userPwd, userName, gender, age, email, phone, address, hoppy);
	}
	...
	public void updateMember() {
		...
		//(어떤 사람을 찾기위한)아이디, 비밀번호, 이메일, 전화번호, 주소
	...
	/**
	 * 조회 서비ㅐ스 요청시 조회결과가 없을 때 사용자가 보게될 응답화면
	 ...
	 * @param list : 출력할 member가 담겨있는 list
	 */
